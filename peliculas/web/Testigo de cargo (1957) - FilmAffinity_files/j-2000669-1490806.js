...
var ft2000669 = {
    confID:window.ftConfID_2000669||"0",
    GUID:window.ftGUID_2000669||"99999999999",
    ftId:'',
    ftImpId: window.ftImp2000669 && window.ftImp2000669.impID,
    params:window.ftParams_2000669||"",
    segment:window.ftSegment_2000669||"",
    segmentList:window.ftSegmentList_2000669||[],
    keyword:window.ftKeyword_2000669||"",
    ftReturn: window.ftReturn_2000669||"",
    exttrack:[],
    extscript:[""],
    pID:"2000669",
    cID:"62263",
    campaignID:"65540",
    siteName:"SmartClip",
    placementDescription:"980x200SkinVideoExpandLUGARENO18398137BBVAVERANOJUL16ES",
    creativeID:"1490806",
    width:980,
    height:200,
    divID:"ftdiv2000669",
    phID:"ftpos2000669",
    frameID:"ftframe2000669",
    expID:"ftexpframe2000669",
    altImgID:"ftalt2000669",
    clickTags: ["http://servedby.flashtalking.com/click/2/65540;2000669;1490806;211;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=980&ft_height=200&url=https://bs.serving-sys.com/BurstingPipe/adServer.bs?cn=tf&c=20&mc=click&pli=18398137&PluID=0&ord=[FT_RANDOM]"],
    altText:"Click here",
    altImgTarget:"_blank",
    altImgHref:"http://servedby.flashtalking.com/click/2/65540;2000669;1490806;210;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=980&ft_height=200&url=https://bs.serving-sys.com/BurstingPipe/adServer.bs?cn=tf&c=20&mc=click&pli=18398137&PluID=0&ord=[FT_RANDOM]",
    altImg:"http://servedby.flashtalking.com/imp/2/65540;2000669;204;gif;SmartClip;980x200SkinVideoExpandLUGARENO18398137BBVAVERANOJUL16ES/?",
    viewableImpressionURL: "http://servedby.flashtalking.com/imp/2/65540;2000669;202;pixel;SmartClip;980x200SkinVideoExpandLUGARENO18398137BBVAVERANOJUL16ES/?",
    iDeviceImp:'http://servedby.flashtalking.com/imp/2/65540;2000669;207;guid;SmartClip;980x200SkinVideoExpandLUGARENO18398137BBVAVERANOJUL16ES/?ft_guid=[%'+'FT_GUID%]&cachebuster=[%'+'CACHEBUSTER%]',
    stump: "http://servedby.flashtalking.com",
    jsurl:"http://cdn.flashtalking.com/xre/200/2000669/1490806/js/j-2000669-1490806.js",
    file:"http://cdn.flashtalking.com/62263/1490806/index.html",
    ...
    statBaseURL:"http://stat.flashtalking.com/reportV3/ft.stat?69140242-2000669;1490806;",
    adVis: true ? 1 : 0,
    centreAd:'true' === 'true',
    adWindow:null,
    mvt:false,
    ...
    scriptLocation: document.getElementById("ftscript_m2000669"),
    ...
    iframe: false,
    w:window,
    secure: location.protocol === 'https:'||!!(document.querySelector&&document.querySelector('#ftscript_m2000669[src^="https:"]')) || window.qs && typeof qs.get === 'function' && /^https:/.test(qs.get('ifsrc','')),
    append: window.ftImp2000669 && window.ftImp2000669.jsAppend,
    ...
    qsVars:[
        ["ftguid","ftGUID_2000669"],
        ["ftcfid","ftConfID_2000669"],
        ["fttime","ftTimestamp_2000669"],
        ["ftsection","ftSection_2000669"],
        ["ftcustom","ftCustom_2000669"],
        ["ft_id", "ftId_2000669"],
        ["ftimpid","ftImp2000669", "impID"]
    ],
    event:{
        INTERACTION: "18",
        INTERACTION_TIME: "19",
    ...
    api:{
        ...
        getOrientation: function(width, height) {
            ...
            if(ft2000669.goneFullscreen && width) {
                if(or%180===0) {
