...
var ft2042892 = {
    confID:window.ftConfID_2042892||"0",
    GUID:window.ftGUID_2042892||"99999999999",
    ftId:'',
    ftImpId: window.ftImp2042892 && window.ftImp2042892.impID,
    params:window.ftParams_2042892||"",
    segment:window.ftSegment_2042892||"",
    segmentList:window.ftSegmentList_2042892||[],
    keyword:window.ftKeyword_2042892||"",
    ftReturn: window.ftReturn_2042892||"",
    exttrack:[],
    extscript:[""],
    pID:"2042892",
    cID:"63038",
    campaignID:"66858",
    siteName:"SmartClip",
    placementDescription:"980x200SkinvideoExpFA18662223UNIVERSALKUBOAGO16",
    creativeID:"1496856",
    width:980,
    height:200,
    divID:"ftdiv2042892",
    phID:"ftpos2042892",
    frameID:"ftframe2042892",
    expID:"ftexpframe2042892",
    altImgID:"ftalt2042892",
    clickTags: ["http://servedby.flashtalking.com/click/2/66858;2042892;1496856;211;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=980&ft_height=200&url=https://bs.serving-sys.com/BurstingPipe/adServer.bs?cn=tf&c=20&mc=click&pli=18662223&PluID=0&ord=[FT_RANDOM]","http://servedby.flashtalking.com/click/2/66858;2042892;1496856;212;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=980&ft_height=200&url=https://bs.serving-sys.com/BurstingPipe/adServer.bs?cn=tf&c=20&mc=click&pli=18662223&PluID=0&ord=[FT_RANDOM]","http://servedby.flashtalking.com/click/2/66858;2042892;1496856;213;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=980&ft_height=200&url=https://www.facebook.com/universalpicturesspain","http://servedby.flashtalking.com/click/2/66858;2042892;1496856;214;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=980&ft_height=200&url=https://twitter.com/Universal_Spain","http://servedby.flashtalking.com/click/2/66858;2042892;1496856;215;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=980&ft_height=200&url=https://www.instagram.com/universal_spain/","http://servedby.flashtalking.com/click/2/66858;2042892;1496856;216;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=980&ft_height=200&url=https://www.youtube.com/watch?v=JCdfrFcPXp4"],
    altText:"Click here",
    altImgTarget:"_blank",
    altImgHref:"http://servedby.flashtalking.com/click/2/66858;2042892;1496856;210;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=980&ft_height=200&url=https://bs.serving-sys.com/BurstingPipe/adServer.bs?cn=tf&c=20&mc=click&pli=18662223&PluID=0&ord=[FT_RANDOM]",
    altImg:"http://servedby.flashtalking.com/imp/2/66858;2042892;204;gif;SmartClip;980x200SkinvideoExpFA18662223UNIVERSALKUBOAGO16/?",
    viewableImpressionURL: "http://servedby.flashtalking.com/imp/2/66858;2042892;202;pixel;SmartClip;980x200SkinvideoExpFA18662223UNIVERSALKUBOAGO16/?",
    iDeviceImp:'http://servedby.flashtalking.com/imp/2/66858;2042892;207;guid;SmartClip;980x200SkinvideoExpFA18662223UNIVERSALKUBOAGO16/?ft_guid=[%'+'FT_GUID%]&cachebuster=[%'+'CACHEBUSTER%]',
    stump: "http://servedby.flashtalking.com",
    jsurl:"http://cdn.flashtalking.com/xre/204/2042892/1496856/js/j-2042892-1496856.js",
    file:"http://cdn.flashtalking.com/63038/1496856/index.html",
    ...
    statBaseURL:"http://stat.flashtalking.com/reportV3/ft.stat?69636597-2042892;1496856;",
    adVis: true ? 1 : 0,
    centreAd:'true' === 'true',
    adWindow:null,
    mvt:false,
    ...
    zIndex:+'77000' || 77000,
    blockBrowsers:"ie8,ie7,opera".split(","),
    absorbSwipes: 'false' === 'true',
    loadMethod: 'DOM Loaded'.replace(/^(?!(?:DOM Loaded|Full Load)$).*$/i, 'Quick Load'),
    adDisplayed:false,
    baggyFrameLimit: +'15' || 15,
    clicks:{},
    cachedBodyStyles:{},
    fVarList:{},
    cachedEvents: [],
    ...
    scriptLocation: document.getElementById("ftscript_m2042892"),
    ...
    iframe: false,
    w:window,
    secure: location.protocol === 'https:'||!!(document.querySelector&&document.querySelector('#ftscript_m2042892[src^="https:"]')) || window.qs && typeof qs.get === 'function' && /^https:/.test(qs.get('ifsrc','')),
    append: window.ftImp2042892 && window.ftImp2042892.jsAppend,
    ...
    qsVars:[
        ["ftguid","ftGUID_2042892"],
        ["ftcfid","ftConfID_2042892"],
        ["fttime","ftTimestamp_2042892"],
        ["ftsection","ftSection_2042892"],
        ["ftcustom","ftCustom_2042892"],
        ["ft_id", "ftId_2042892"],
        ["ftimpid","ftImp2042892", "impID"]
    ],
    event:{
        INTERACTION: "18",
        INTERACTION_TIME: "19",
    ...
    api:{
        ...
        getOrientation: function(width, height) {
            ...
            if(ft2042892.goneFullscreen && width) {
                if(or%180===0) {
...
//--start extensions
(function(o){var dimensions = function(){var w = o.w.innerWidth|| o.w.document.documentElement.clientWidth || o.w.document.body.clientWidth,h = o.w.innerHeight|| o.w.document.documentElement.clientHeight || o.w.document.body.clientHeight;return[w,h];};o.addEventListener('start', function(){           if(frameElement){                 frameElement.style.display = "block";           }});o.receiveMethod.SMARTVIEW = function() {          if(ftCustomViewTrack_2042892 != "" || ftCustomViewTrack_2042892 != null || ftCustomViewTrack_2042892 != undefined){            var myImage = new Image();            myImage.src = ftCustomViewTrack_2042892;}}o.addEventListener('expand', function(){var d = dimensions();o.$().style.position = 'fixed';o.$().style.width = d[0] + 'px';o.$().style.height = d[1] + 'px';          o.$().style.zIndex = '16777271';});o.addEventListener('resize', function(){var d = dimensions();o.$().style.width = d[0] + 'px';o.$().style.height = d[1] + 'px';});o.addEventListener('contract', function(){o.$().style.position = 'relative';o.$().style.width = o.width + 'px';o.$().style.height = o.height + 'px';o.$().style.zIndex = '0';});o.addEventListener('end', function(){o.$(this.phID).style.position = 'relative';});})(ft2042892);ft2042892.baggyFrameLimit=1500000;
