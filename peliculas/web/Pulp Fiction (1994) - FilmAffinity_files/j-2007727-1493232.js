...
var ft2007727 = {
	confID:window.ftConfID_2007727||"0",
	GUID:window.ftGUID_2007727||"99999999999",
	ftId:'',
    ftImpId: window.ftImp2007727 && window.ftImp2007727.impID || '',
	params:window.ftParams_2007727||"",
	segment:window.ftSegment_2007727||"",
	segmentList:window.ftSegmentList_2007727||[],
	keyword:window.ftKeyword_2007727||"",
	ftReturn: window.ftReturn_2007727||"",
	exttrack:[],
	extscript:[""],
	pID:"2007727",
	cID:"63002",
	campaignID:"66183",
	siteName:"SmartClip",
	placementDescription:"980x200SkinVideoWallEONENERVEAGO16ES",
	creativeID:"1493232",
	width:980,
	height:200,
	divID:"ftdiv2007727",
	frameID:"ftframe2007727",
	altImgID:"ftalt2007727",
	altText:"Click here",
	altImgTarget:"_blank",
	altImgHref:"http://servedby.flashtalking.com/click/2/66183;2007727;1493232;210;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=980&ft_height=200&url=https://bs.serving-sys.com/BurstingPipe/adServer.bs?cn=tf&c=20&mc=click&pli=18558279&PluID=0&ord=[FT_RANDOM]",
    tracking3rdParty: {
        videoQuartiles: JSON.parse('[%thirdparty_video_quartiles%]'.replace(/^(\[%\w+%])?$/, '{}')),
        userEngagement: '[%thirdparty_user_engagement%]'.replace(/^\[%\w+%\]$/, '')
    },
	clickTags: ["http://servedby.flashtalking.com/click/2/66183;2007727;1493232;211;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=980&ft_height=200&url=https://bs.serving-sys.com/BurstingPipe/adServer.bs?cn=tf&c=20&mc=click&pli=18558279&PluID=0&ord=[FT_RANDOM]"],
	altImg:"http://servedby.flashtalking.com/imp/2/66183;2007727;204;gif;SmartClip;980x200SkinVideoWallEONENERVEAGO16ES/?",
	viewableImpressionURL: "http://servedby.flashtalking.com/imp/2/66183;2007727;202;pixel;SmartClip;980x200SkinVideoWallEONENERVEAGO16ES/?",
    stump: "http://servedby.flashtalking.com",
	file:"http://cdn.flashtalking.com/63002/1493232/videowall_billboard.html",
	...
	statBaseURL:"http://stat.flashtalking.com/reportV3/ft.stat?69167790-2007727;1493232;",
	centreAd:true,
    iDeviceImp:"http://servedby.flashtalking.com/imp/2/66183;2007727;207;guid;SmartClip;980x200SkinVideoWallEONENERVEAGO16ES/?ft_guid=[%"+"FT_GUID%]&cachebuster=[%"+"CACHEBUSTER%]",
	adWindow:null,
	mvt:false,
	...
	adDisplayed: false,
	adReady: false,
	loadMethod:"DOM Loaded",
	secure: location.protocol === 'https:'||!!(document.querySelector&&document.querySelector('#ftscript_m2007727[src^="https:"]')) || window.qs && typeof qs.get === 'function' && /^https:/.test(qs.get('ifsrc','')),
	storeGUID:/iP(ad|hone|od)/.test(navigator.appVersion),
	scriptLocation: document.getElementById('ftscript_m2007727'),
	customPos: false,
	...
	nuke: function(){
        ...
        if (this.cachedEvents) {
            while(this.cachedEvents.length) {
                ...
                this.removeListener(ev[0], ev[1], ev[2]);
            }
        }
	},
	$:function(el){
	...
	outputDiv:function(fullAd){
		...
		if(badWrite || (window.ftImp2007727 && window.ftImp2007727.jsAppend)) {
...
//--start extensions
(function(o){var videowall_ftdiv = "ftdiv2007728";o.receiveMethod.start = function(){var vw = window.parent.document.getElementById(videowall_ftdiv);vw.style.zIndex = 1000000;};})(ft2007727);
